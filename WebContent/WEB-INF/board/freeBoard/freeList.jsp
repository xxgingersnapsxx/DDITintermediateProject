...
<%
   List<FreeBoardVO> freeList =
      (List<FreeBoardVO>) request.getAttribute("freeList");
%>
    <!-- Navigation -->
...
<%
       ...
       for(FreeBoardVO freeVo : freeList) {
%>
<!-- <tr style="background:url('img/table_mid.gif') repeat-x; text-align:center;"> -->
<!--    <td width="5"><img src="img/table_left.gif" width="5" height="30" /></td> -->
<tbody>
<tr>
<!--    <td width="5"><width="5" height="30" /></td> -->
	<td><%=freeVo.getFree_id() %></td>
   <td><a href="<%=request.getContextPath()%>/freeSelect.do?idx=<%=freeVo.getFree_id() %>"><%=freeVo.getFree_title() %></a></td>
   <td><%=freeVo.getMember_id() %></td>
   <td><%=freeVo.getFree_date() %></td>
   <td><%=freeVo.getFree_count() %></td>
<!-- 	<td width="7"><img src="img/table_right.gif" width="5" height="30" /></td> -->
<!-- 	<td width="7"><width="5" height="30" /></td> -->
</tr>
</tbody>
...
<!--   <tr><td colspan="4" height="5"></td></tr> -->
  <tr align="center">
   <td><input type=button value="글쓰기" id="freeListBtn"></td>
  </tr>
</table>
