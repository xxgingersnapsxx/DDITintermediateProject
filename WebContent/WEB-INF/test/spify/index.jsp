...
<!--                                                 <img class="img-fluid" src="images/hongchul.jpg" alt="alternative"> -->
                                              <img class="img-fluid" src="<%=request.getContextPath() %>/<%=picList.get(22) %>" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="image-container">
                                                <img class="img-fluid" src="images/Jung.jpg" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6">
                                            <div class="text-container">
    ...
    <div id="chat" class="basic-7">
        <div class="container">
            <div class="row">
             ...
             <iframe name="ifr" width="500px" height="300px" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0> </iframe> 
        </div> <!-- end of container -->
    </div> <!-- end of basic-7 -->
    <!-- end of invitation -->
