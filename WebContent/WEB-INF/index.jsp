                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="image-container">
<!--                                                 <img class="img-fluid" src="images/아메리카노.jpg" alt="alternative"> -->
<!--                                                 <img class="img-fluid" src="../matchingImg/hongchul.jpg" alt="alternative"> -->
                                                <img class="img-fluid" src="<%=request.getContextPath() %>/<%=picList.get(0) %>" alt="alternative" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="image-container">
                                                <img class="img-fluid" src="images/에스프레소.jpg" alt="alternative">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a class="btn-solid-lg page-scroll" href="match.html" target="ifr">매치</a>
                    <a class="btn-solid-lg page-scroll" href="chat.html" target="ifr">메시지</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
                   <iframe name="ifr" width="500px" height="300px" background = white> </iframe> 
        </div> <!-- end of container -->
    </div> <!-- end of basic-7 -->
    <!-- end of invitation -->
