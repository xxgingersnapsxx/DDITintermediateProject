...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index.html">DaManNa</a>  
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#QnA">QnA</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#city">City Board</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#about">Review</a>
                    </li>
...
<!--                         <img class="img-fluid" src="images/damanna.png" alt="alternative"> -->
<!--                     </div> end of image-container -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="image-container">
                                                <img class="img-fluid" src="images/Jung2.jpg" alt="alternative">
                                            </div> <!-- end of image-container -->
                                        </div> <!-- end of col -->
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                                <h4>정창균</h4>
                                                <p>만28살</p>
                                                <p class="testimonial-text">"안녕 나를 소개하지 이름은 정창균 직업은 traveler 취미는 tai chi, meditation, 독서, 영화시청 랩해 터 털어 너 그리고 날위해 증오는 빼는 편이야 가사에서 질리는 맛이기에"</p>     
                                            </div> <!-- end of text-container -->
                                        </div> <!-- end of col -->
                                    </div> <!-- end of row -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                                 <h4>정창균</h4>
                                                <p>만28살</p>
                                                <p class="testimonial-text">"취미는 요리"</p>   
                                            </div> <!-- end of text-container -->
                                        </div> <!-- end of col -->
                                    </div> <!-- end of row -->
                                </div> <!-- end of swiper-slide -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                                 <h4>정창균</h4>
                                                <p>만28살</p>
                                                <p class="testimonial-text">"취미는 등산"</p>   
                                            </div> <!-- end of text-container -->
                                        </div> <!-- end of col -->
                                    </div> <!-- end of row -->
                                </div> <!-- end of swiper-slide -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                                 <h4>정창균</h4>
                                                <p>만28살</p>
                                                <p class="testimonial-text">"취미는 런닝"</p>   
                                            </div> <!-- end of text-container -->
                                        </div> <!-- end of col -->
                                    </div> <!-- end of row -->
                                </div> <!-- end of swiper-slide -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="text-container">
                                                 <h4>정창균</h4>
                                                <p>만28살</p>
                                                <p class="testimonial-text">"동네친구구함"</p>   
                                            </div> <!-- end of text-container -->
                                        </div> <!-- end of col -->
                                    </div> <!-- end of row -->
                                </div> <!-- end of swiper-slide -->
	...
	<div style = "text-align:center">
		<a><img src="images/icon.jpg" alt=""></a>
	</div>
    </div> <!-- end of slider-1 -->
    <!-- end of projects -->
...
<!--     end of about -->
    ...
    <div id="chat" class="basic-7">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <a class="btn-solid-lg page-scroll" href="mypage.html">나의 프로필</a>
                    <a class="btn-solid-lg page-scroll" href="match2.jsp" target="ifr">매치</a>
                    <a class="btn-solid-lg page-scroll" href="chat2.jsp" target="ifr2">메시지</a>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
             <iframe name="ifr" width="400px" height="400px" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0> </iframe> 
             <iframe name="ifr2" width="400px" height="400px" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0> </iframe> 
        </div> <!-- end of container -->
    </div> <!-- end of basic-7 -->
    <!-- end of invitation -->
...
<!--             <div class="row"> -->
<!--                 <div class="col-lg-12"> -->
<!--                 <iframe name="ifr2" width="1000px" height="300px"> </iframe>  -->
